/* 200 common Guaraní expressions for the standalone "Expresiones Comunes" section.
   ...
   An optional 4th column is a hand-written pronunciation guide that overrides the one
   generated by Pron.guide(), e.g. ["Ñande reko", "…", "…", "ÑAN-de re-KO"]. */
const _EXPRESSIONS_BY_CATEGORY = {
  "Saludos": [
    ...
    ["Iporãiterei", "Muy bien", "Very well", "i-po-rã-i-te-re-I"],
  ...
  "Despedidas": [
    ...
    ["Ko'ẽro meve", "Hasta mañana", "Until tomorrow"],
  ...
  "Cortesía": [
    ...
    ["Ani rembyasy", "No te preocupes", "Don't worry"],
  ...
  "Presentaciones": [
    ...
    ["Che paraguáyo", "Soy paraguayo", "I'm Paraguayan", "che pa-ra-GUÁ-yo"],
  ...
  "Familia": [
    ...
    ["Che kyvy", "Mi hermano (de una mujer)", "My brother (woman speaking)"],
    ["Che reindy", "Mi hermana (de un varón)", "My sister (man speaking)"],
    ["Che ñemoñare", "Mis hijos", "My children"],
    ["Che jarýi", "Mi abuela", "My grandmother"],
    ["Che tamói", "Mi abuelo", "My grandfather"],
  ...
  "Tiempo y clima": [
    ...
    ["Iñypytũ", "Está oscuro", "It's dark"],
    ["Mba'éichapa ára ko'ágã", "¿Cómo está el clima?", "How's the weather?"],
    ["Ára porã", "Buen tiempo", "Good weather"],
    ["Ama guasu", "Tormenta", "Storm"]
  ],
  "Compras": [
    ["Mboýpa hepy", "¿Cuánto cuesta?", "How much is it?"],
    ["Hepýeterei", "Es muy caro", "It's very expensive", "he-pɨ-e-te-re-I"],
  ...
  "Salud": [
    ["Che rasy", "Estoy enfermo", "I'm sick"],
    ["Che akãrasy", "Me duele la cabeza", "I have a headache", "che a-kã-ra-SƗ"],
    ["Che ryerasy", "Me duele la panza", "I have a stomachache"],
    ["Aipota pohã", "Necesito remedio", "I need medicine"],
    ["Aha pohãnohárape", "Voy al médico", "I'm going to the doctor"],
    ["Tesãi", "Salud", "Health"],
  ...
  "Viajes": [
    ["Aguatáta", "Voy a viajar", "I'm going to travel"],
    ["Moõpa reho", "¿A dónde vas?", "Where are you going?"],
  ...
  "Amor y amistad": [
    ...
    ["Ñande mborayhu tuicha", "Nuestro amor es grande", "Our love is great", "ÑAN-de mbo-ra-ɨ-HU tui-CHA"],
  ...
  "Expresiones populares": [
    ...
    ["Iporãite", "Está buenísimo", "It's great", "i-po-rã-i-TE"],
...
const EXPRESSIONS = Object.keys(_EXPRESSIONS_BY_CATEGORY).reduce((acc, category) => {
  _EXPRESSIONS_BY_CATEGORY[category].forEach(function (row) {
    ...
    // `pron` (optional 4th column) overrides the generated phonetic guide.
    acc.push({ id: "expr-" + acc.length, guarani: row[0], spanish: row[1], english: row[2],
               pron: row[3], category: category });
  });
  return acc;
}, []);
