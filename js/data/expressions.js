/* 200 common Guaraní expressions for the standalone "Expresiones Comunes" section.
   ...
   generated by Pron.guide(), e.g. ["Ñande reko", "…", "…", "ÑA-nde re-KO"]. */
const _EXPRESSIONS_BY_CATEGORY = {
  "Saludos": [
    ...
    ["Iporãiterei", "Muy bien", "Very well", "i-po-rãi-te-REI"],
  ...
  "Compras": [
    ...
    ["Hepýeterei", "Es muy caro", "It's very expensive", "he-pɨ-e-te-REI"],
  ...
  "Amor y amistad": [
    ...
    ["Ñande mborayhu tuicha", "Nuestro amor es grande", "Our love is great", "ÑA-nde mbo-raɨ-HU tui-CHA"],
  ...
  "Expresiones populares": [
    ...
    ["Iporãite", "Está buenísimo", "It's great", "i-po-rãi-TE"],
